...
export default async function BlogPost({params}: {params: Promise<{id: string}>}) {
    ...
    let post: Post;
    const imgSrc = 'https://picsum.photos/1300/600'
      ...
      <div className='page-content'>
        ...
        <div className='post'>
          ...
          <div className="post__media">
            <Image src={imgSrc} alt='post cover image' sizes="100vw" width='1300' height='600' style={{objectFit: 'cover', width: '100%', height: '100%'}}/>
          </div>
